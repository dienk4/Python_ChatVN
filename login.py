...
# tkinter
    ...
    def check_connect(self, event=None):
        ...
        if search_entry == '' or search_entry == 'Tìm kiếm người bạn kết nối':
            ...
            conn.close()
            if row:
                yes = messagebox.askyesno('Thông báo - ChatVN',
                ...
                if yes:
                    ...
                    self.list_f2 = Label(self.listFrame_f2,
                                         text=f'{search_entry}                                                            ',
                                         bg="#66CCFF", font=("Arial", 13),
                ...
                messagebox.showerror('Lỗi - ChatVN',
                                     'Không tìm thấy tên trong hệ thống\nCó thể họ chưa hoạt động hoặc chưa kết nối app')
    def receive_message(self):
        while True:
            ...
            if message_str:
                ...
                message_label = Label(message_frame, text=f"{message}", bg="#E0FFFF", anchor='w', font=("Arial", 13),
                                      wraplength=350)
                ...
                ba_cham_label_receive = Label(img_frame_receive, text="...", bg="#E0FFFF", font=("Arial", 14),
                                              cursor='hand2')
    ...
    def send_picture(self):
        ...
        if self.search_entry.get() == '' or self.search_entry.get() == 'Tìm kiếm người bạn kết nối':
            ...
            with open(self.file_path, 'rb') as f:
                ...
                message_frame = Frame(self.text_mes_f6, bg="white", relief=FLAT, padx=10, pady=5,
                                      highlightbackground='#E6E6FA',
                                      highlightthickness=1)

                message_label = Label(message_frame, image=photo, bg="white", font=("Arial", 10), wraplength=350,
                                      cursor='hand2')
    ...
    def send_message(self, event=None):
        ...
        if message == '' or message == 'Nhập @, tin nhắn tới ...':
            ...
            message_label = Label(message_frame, text=message, bg="white", font=("Arial", 13), wraplength=350,
                                  anchor='w')
            message_label.pack(side=LEFT)
